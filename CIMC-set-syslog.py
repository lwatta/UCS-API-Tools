...
# Set syslog on the servers via the api
...
#	pwstatus = ucs.get_imc_managedobject(None, params={'Dn': 'sys/svc-ext/syslog/client-primary'})[0]
	pwstatus = ucs.get_imc_managedobject(None, params={'Dn': 'sys/svc-ext/syslog'})[0]
	print pwstatus.LocalSeverity
	print pwstatus.RemoteSeverity
	status1 = ucs.set_imc_managedobject(pwstatus, class_id="CommSyslog", params={'Dn': 'sys/svc-ext/syslog','localSeverity': 'informational', 'remoteSeverity': 'informational'})
